...
export const GROUPS: FoodGroup[] = [
  ...
  },
  {
    ...
    items: [
      // 品名不標日期：菜色會重複出現，標了日期學生會以為只能選那一天的。
      // 每一筆原本的登錄日期與廠商記在這裡，方便日後回平臺核對。
      { e: "🍱", n: "A 餐", p: "香烤腿排・香酥蝦捲", parts: {grain: 5.13, prot: 4.59, veg: 1, fat: 0.06}, ex: {kc: 689} },    // 9/2 可口味
      { e: "🍱", n: "B 餐", p: "便當", parts: {grain: 6.68, prot: 1.56, veg: 0.58, fat: 4}, ex: {kc: 792} },                // 9/8 讚美食
      { e: "🍱", n: "C 餐", p: "糖醋豬排骨・酸菜麵腸", parts: {grain: 5.66, prot: 3.6, veg: 1.07, fat: 2}, ex: {kc: 734} },  // 9/9 讚美食
      { e: "🍱", n: "D 餐", p: "日京醬肉絲・炒冬粉", parts: {grain: 6.51, prot: 2.95, veg: 0.4, fat: 1}, ex: {kc: 866} },    // 9/10 讚美食
    ],
  },
  {
